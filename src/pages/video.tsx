  ...
  return (
    <main>
      ...
      <Box mt="54px" className={styles.videoBox}>
        <iframe src="https://www.youtube-nocookie.com/embed/ACgTZ01d9O0?modestbranding=1&rel=0&cc_load_policy=1&fs=0&showinfo=0" width="100%" height="100%" frameBorder="0" />
      </Box>
      <Footer />
    </main>
  )
